export const ru = {
  metadata: {
    title: "Сайты для малого бизнеса за неделю | Руслан",
    description:
      "Делаю сайты для небольшого бизнеса: услуги, цены, примеры работ и запись. Макет главной страницы — бесплатно за сутки, сайт — за неделю, цену называю до начала работы.",
  ...
  hero: {
    ...
    subtitle:
      "Нарисую, как будет выглядеть ваша главная: услуги, цены, примеры работ и удобная связь с клиентом. Понравится — соберу сайт за неделю.",
  ...
  formats: {
    ...
    note: "Цену называю до начала работы и не меняю по ходу. Первый месяц после запуска мелкие правки бесплатно, дальше — пакет из 5 правок за $60.",
    ...
    items: [
      {
        ...
        price: "$450",
        description:
          "Одна страница с услугами, ценами, работами и связью. Макет главной рисую бесплатно за сутки, дальше предоплата 30% и неделя работы.",
      },
      {
        title: "Сайт с каталогом",
        price: "$850",
        description:
          "Несколько страниц, каталог товаров или номеров, фильтры, бронирование. Когда одной страницы мало.",
      },
    ],
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Нравится — за неделю собираю рабочий сайт, подключаю форму и домен, помогаю запустить.",
      },
      {
  ...
  about: {
    ...
    facts: [
      ...
      "Макет главной — за сутки, сайт — за неделю",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Макет главной — сутки. Готовый сайт — неделя с момента предоплаты. Логотип, визитка или меню — два-три дня. Если у вас горит, скажите сразу: посмотрю, что можно сделать.",
      },
      {

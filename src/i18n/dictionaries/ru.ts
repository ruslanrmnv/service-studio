export const ru = {
    ...
    items: [
      {
        ...
        price: "450 €",
        description:
          "Сайт для мастера, салона или студии: чтобы вас нашли и написали напрямую.",
        includes: [
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "У меня уже есть сайт — можете переделать?",
        a: "Да, это та же работа и та же цена. Домен остаётся ваш и с тем же адресом; старый сайт живёт, пока новый не готов, так что вы не пропадаете из сети ни на день. А если старый находится в Google, я сохраняю его прежние адреса рабочими — чтобы тот, кто вас искал, не упёрся в пустоту.",
      },
      {
